...
var taskApiBaseUrl = builder.Configuration["TaskApi:BaseUrl"] ?? Environment.GetEnvironmentVariable("TASK_API_BASE_URL") ?? "http://localhost:5101";
var userApiBaseUrl = builder.Configuration["UserApi:BaseUrl"] ?? Environment.GetEnvironmentVariable("USER_API_BASE_URL") ?? "http://localhost:5102";
